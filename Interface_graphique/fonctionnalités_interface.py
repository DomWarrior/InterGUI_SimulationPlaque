...
def sauvegarder_résultats_txt(fichier, times, temp1, temp2, temp_laser, energy): #Fonction qui va enregistrer les résultats des températures aux différents points d'intérêts en fonction du temps dans un fichier txt
